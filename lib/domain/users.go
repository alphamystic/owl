...
func (d *Domain) CreateHash(h ent.UserHash,ctx context.Context) error {
...
func (d *Domain) GetHash(userId string,ctx context.Context) (*ent.UserHash,error) {
  conn,err := d.GetConnection(ctx)
  if err != nil {
...
func (d *Domain) CreateUser(u ent.User,ctx context.Context) error {
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) ViewUser(userId string,ctx context.Context) (*ent.User,error) {
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) ListMyUsers(ownerId string,active,verified bool) ([]ent.User,error) {
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) AdminListUsers(active bool,ctx context.Context) ([]ent.User,error) {
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) ListAllUsers(active bool,ctx context.Context) ([]ent.User,error) {
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return fmt.Errorf("Error getting db connection: %q",err)
  }
