...
func (d *Domain) CreateMinion(m ent.Minion,ctx context.Context) error {
...
func (d *Domain) ListInstalledMinions(mine bool,ownerId strinng,ctx context.Context) ([]ent.Minion,error) {
  conn,err := d.GetConnection(ctx)
  if err != nil {
...
func (d *Domain) ListAllMinionsFromASpecificMotherShip(msid string,ctx context.Context)([]ent.Minion,error){
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) ListInstalledMinionsFromAMotherShip(msid string,ctx context.Context)([]ent.Minion,error){
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) ListAllMinions(ctx context.Context)([]ent.Minion,error){
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
...
func (d *Domain) ViewMinion(minionId string,ctx context.Context)(*ent.Minion,error){
  conn,err := d.GetConnection(ctx)
  if err != nil {
    return nil,fmt.Errorf("Error getting db connection: %q",err)
  }
